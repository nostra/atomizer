...
public class GuiEntry {
    ...
    */
    ...
    public Date getUpdated() {
        return updated; // NOSONAR Erlend does not care that date is mutable
    }

    public void setUpdated(Date updated) {
        this.updated = updated; // NOSONAR Erlend does not care that date is mutable
    }
    ...
    public String getAge() {
        return  ((System.currentTimeMillis() - updated.getTime()) / 1000)+" sec";
    }
